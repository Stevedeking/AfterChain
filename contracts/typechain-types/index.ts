...
export type { AfterchainRegistry } from "./contracts/AfterchainRegistry";
export { AfterchainRegistry__factory } from "./factories/contracts/AfterchainRegistry__factory";
export type { AfterchainWill } from "./contracts/AfterchainWill";
export { AfterchainWill__factory } from "./factories/contracts/AfterchainWill__factory";
